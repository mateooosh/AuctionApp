<template>
    <section :class="{'even': i%2 == 1}" class="table">
        ...
        <div>
            <i @click="$emit('end', auction.auctionId, auction.auctionStatus)" style="margin: 0 5px" :class="{'disabled': auction.auctionStatus !== 'w trakcie'}" class="fas fa-trash-alt fa-lg"></i>
            <i @click="$emit('start', auction.auctionId, auction.auctionStatus)" style="margin: 0 5px" :class="{'disabled': auction.auctionStatus !== 'zakończona'}" class="fas fa-undo-alt fa-lg"></i>
