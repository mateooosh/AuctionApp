<template>
  <div class="form">
    ...
    <form class="form__title">
      ...
      <input @change="isCorrectTitle = validateMin3Char(title)" v-model="title" class="form__title__input" name="title"
    ...
    <form class="form__startingPrice">
      <label class="form__startingPrice__label" for="startingPrice">Cena początkowa<span
          style="color: red;">*</span></label>
      <input v-model="startingPrice" class="form__startingPrice__input" min="0" name="startingPrice" type="number"
             placeholder="Cena początkowa">
    </form>

    <form class="form__instantPrice">
      <label class="form__instantPrice__label" for="instantPrice">Cena błyskawiczna<span
          style="color: red;">*</span></label>
      <input v-model="instantPrice" class="form__instantPrice__input" min="0" name="instantPrice" type="number"
             placeholder="Cena błyskawiczna">
    </form>

    <form class="form__description">
      <label class="form__description__label" for="description" :data-after-content="remainingCharacters">Opis
        przedmiotu<span style="color: red;">*</span></label>
      <!-- <input v-model="description" class="form__description__input" name="description" type="textarea" placeholder="Tytuł"> -->
      <textarea @change="isCorrectDescription = validateMin3Char(description)" @keyup="calcChar" v-model="description"
                name="description" class="form__description__input" placeholder="Opis..." maxlength="500"></textarea>
    </form>
    ...
    <form class="form__photos">
      ...
      <input @change="displayPhotos" class="form__photos__input" accept="image/*" id="photo" type="file"
