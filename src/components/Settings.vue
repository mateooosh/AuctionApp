      ...
      <div class="settings__content">
        <div>
          <form class="settings__firstname">
            <label :class="{'wrong-firstname': !isCorrectFirstname}" class="settings__firstname__label" for="firstname">Imię<span
                style="color: red;">*</span></label>
            <input v-model="firstname" @change="isCorrectFirstname = validateMin3Char(firstname)"
                   class="settings__firstname__input" name="firstname" type="text" placeholder="Imię">
          </form>

          <form class="settings__lastname">
            <label :class="{'wrong-lastname': !isCorrectLastname}" class="settings__lastname__label" for="lastname">Nazwisko<span
                style="color: red;">*</span></label>
            <input v-model="lastname" @change="isCorrectLastname = validateMin3Char(lastname)"
                   class="settings__lastname__input" name="lastname" type="text" placeholder="Nazwisko">
          </form>

          <form class="settings__location">
            <label :class="{'wrong-location': !isCorrectLocation}" class="settings__location__label" for="location">Lokalizacja<span
                style="color: red;">*</span></label>
            <input v-model="location" @change="isCorrectLocation = validateMin3Char(location)"
                   class="settings__location__input" name="location" type="text" placeholder="Miejscowość">
          </form>

          <form class="settings__province">
            <label class="settings__province__label" for="province">Województwo<span
                style="color: red;">*</span></label>
            <select @change="isCorrectProvince = true" v-model="province" class="settings__province__select"
                    name="province">
          ...
          <form class="settings__phone">
            <label :class="{'wrong-phone': !isCorrectPhone}" class="settings__phone__label" for="phone">Numer
              telefonu<span style="color: red;">*</span></label>
            <input v-model="phone" @change="validatePhone" class="settings__phone__input" name="phone" type="text"
      ...
      <div class="settings__content">
        <div>
          <form class="settings__password1">
            <label :class="{ 'wrong-password': !isCorrectPassword1}" class="settings__password1__label"
                   for="settings__password1">Aktualne hasło<span style="color: red;">*</span></label>
            <input v-model="oldPassword" @change="isCorrectPassword1 = validatePassword(oldPassword)"
                   class="settings__password1__input" name="settings__password1" type="password"
                   placeholder="Aktualne hasło" autocomplete="on">
          </form>

          <form class="settings__password2">
            <label :class="{ 'wrong-password': !isCorrectPassword2}" class="settings__password2__label"
                   for="settings__password2">Nowe hasło<span style="color: red;">*</span></label>
            <input v-model="newPassword" @change="isCorrectPassword2 = validatePassword(newPassword)"
                   class="settings__password2__input" name="settings__password2" type="password"
                   placeholder="Nowe hasło" autocomplete="on">
          </form>
        </div>
      ...
      <div class="settings__content">
        <div>
          <form class="settings__email1">
            <label :class="{ 'wrong-email': !isCorrectEmail1}" class="settings__email1__label" for="settings__email1">Aktualny
              e-mail <span style="color: red;">*</span></label>
            <input v-model="oldEmail" @change="isCorrectEmail1 = validateEmail(oldEmail)"
                   class="settings__email1__input" name="settings__email1" type="text" placeholder="Aktualny e-mail">
          </form>

          <form class="settings__email2">
            <label :class="{ 'wrong-email': !isCorrectEmail2}" class="settings__email2__label" for="settings__email2">Nowy
              e-mail<span style="color: red;">*</span></label>
            <input v-model="newEmail" @change="isCorrectEmail2 = validateEmail(newEmail)"
                   class="settings__email2__input" name="settings__email2" type="text" placeholder="Nowy e-mail">
          </form>
        </div>
    ...
    <div class="settings__option">
      ...
      <div class="settings__content">
        <div style="margin-top: 15px; line-height: 1.6;">
          Przykro nam, że zawitałeś w to miejsce, mamy nadzieję, że dzięki naszemu serwisowi dokonałeś niejednego
          udanego zakupu! Kliknięcie na poniższy przycisk spowoduje usunięcie Twojego konta, co za tym idzie, nie będzie
          możliwe zalogowanie się do serwisu wdmj.pl. Jest to nieodwracalna operacja. Jednak dane Twojego konta nie
          zostaną usunięte z naszej bazy klientów.
        </div>
